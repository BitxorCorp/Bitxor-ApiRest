...
const address = {
	...
	publicKeyToAddress: (publicKey, networkIdentifier) => {
		...
		decodedAddress[0] = networkIdentifier[0];
		decodedAddress[1] = networkIdentifier[1];
		arrayUtils.copy(decodedAddress, ripemdHash, constants.sizes.ripemd160, 2);

		// step 4: concatenate (3) and the checksum of (3)
		const hash = jsSha3.sha3_256.arrayBuffer(decodedAddress.subarray(0, constants.sizes.ripemd160 + 2));
		arrayUtils.copy(decodedAddress, arrayUtils.uint8View(hash), constants.sizes.checksum, constants.sizes.ripemd160 + 2);
