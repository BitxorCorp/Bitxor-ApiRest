...
/**
 * Information about a bitxorcore network.
...
const networks = (() => {
	...
	/**
	 * Information about well known bitxorcore networks.
	 ...
	 */
	return {
		mainnet: createNetworkInfo(0x0de2),
		testnet: createNetworkInfo(0x9924)
	};
})();
