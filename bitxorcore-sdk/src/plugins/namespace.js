...
const AliasType = {
	1: 'namespaceDescriptor.alias.token',
...
const namespacePlugin = {
	registerSchema: builder => {
		...
		builder.addTransactionSupport(EntityType.aliasToken, {
			namespaceId: ModelType.uint64HexIdentifier,
		...
		builder.addSchema('namespaceDescriptor.alias.token', {
		...
		builder.addSchema('tokenNames', {
			tokenNames: { type: ModelType.array, schemaName: 'tokenNamesTuple' }
		});

		builder.addSchema('tokenNamesTuple', {
			tokenId: ModelType.uint64HexIdentifier,
	...
	registerCodecs: codecBuilder => {
		...
		codecBuilder.addTransactionSupport(EntityType.aliasToken, {
			deserialize: parser => ({
				namespaceId: parser.uint64(),
				tokenId: parser.uint64(),
				aliasAction: parser.uint8()
			}),
