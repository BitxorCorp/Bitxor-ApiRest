...
describe('status', () => {
	describe('toString', () => {
		...
		it('can output known plugin enum values', () => {
			...
			expect(status.toString(0x80430005)).to.equal('Failure_Core_Genesis_Account_Signed_After_Genesis_Block');
			...
			expect(status.toString(0x804D0002)).to.equal('Failure_Token_Invalid_Name');
