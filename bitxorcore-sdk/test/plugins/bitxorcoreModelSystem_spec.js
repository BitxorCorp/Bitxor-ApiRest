...
const bitxorcoreModelSystem = require('../../src/plugins/bitxorcoreModelSystem');
...
describe('bitxorcore model system', () => {
	describe('basic', () => {
		it('cannot register unknown extension', () => {
			// Act:
			expect(() => bitxorcoreModelSystem.configure(['transfer', 'foo', 'namespace'])).to.throw('plugin \'foo\' not supported');
		});

		it('has support for all plugins', () => {
			// Act:
			const supportedPluginNames = bitxorcoreModelSystem.supportedPluginNames();
	...
	describe('model schema', () => {
		it('can create default schema', () => {
			// Act:
			const system = bitxorcoreModelSystem.configure([], {});
		...
		it('can register single extension', () => {
			// Act:
			const system = bitxorcoreModelSystem.configure(['transfer'], {});
		...
		it('can register multiple extensions', () => {
			// Act:
			const system = bitxorcoreModelSystem.configure(['transfer', 'namespace', 'aggregate'], {});
	...
	describe('codec', () => {
		...
		it('can register multiple extensions', () => {
			// Act:
			const system = bitxorcoreModelSystem.configure(['transfer', 'namespace'], {});
	...
	describe('model formatter', () => {
		it('can create default formatter without extensions', () => {
			// Act:
			const system = bitxorcoreModelSystem.configure([], { default: formattingRules });
		...
		it('can register single extension', () => {
			// Act:
			const system = bitxorcoreModelSystem.configure(['transfer'], { default: formattingRules });
		...
		it('can register multiple extensions', () => {
			// Act:
			const system = bitxorcoreModelSystem.configure(['transfer', 'namespace'], { default: formattingRules });
