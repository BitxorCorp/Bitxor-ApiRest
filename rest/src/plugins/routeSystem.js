...
module.exports = {
	 ...
	 * @returns {array<module:plugins/BitxorcoreRestPlugin~TransactionStateDescriptor>} Additional transaction states to register.
	 */
	configure: (pluginNames, server, db, services) => {
		const transactionStates = [];
		const networkIdentifier = bitxorcore.model.networkInfo.networks[services.config.network.name].id;
