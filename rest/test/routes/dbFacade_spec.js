...
describe('db facade', () => {
	...
	describe('transaction statuses by hashes', () => {
		const addTransactionStatusesByHashesTest = traits => {
			// Arrange:
			const transactionsByHashesFailedStub = sinon.stub(BitxorcoreDb.prototype, 'transactionsByHashesFailed')
				.returns(Promise.resolve(traits.failed || []));
			const transactionsByHashesStub = sinon.stub(BitxorcoreDb.prototype, 'transactionsByHashes')
